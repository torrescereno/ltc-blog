    ...
    <div className="max-w-3xl mx-auto pb-20">
      ...
      <header className="mb-10">
        <div className="flex flex-wrap items-center gap-2 mb-4 text-sm text-muted-foreground">
          ...
          <span>•</span>
          <span className="flex items-center gap-1">
            <Clock size={14} /> {post.readingTime} {t.articleDetail.readingTime}
          </span>
        </div>
      ...
      <div className="mt-12 pt-8 border-t border-border">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {new Date(post.date).toLocaleDateString(t.articleDetail.dateLocale, {
              weekday: "long",
              year: "numeric",
              month: "long",
              day: "numeric",
          ...
          >
            {t.articleDetail.backToAllPosts} <ExternalLink size={14} />
          </Link>
        </div>
      </div>
    </div>
